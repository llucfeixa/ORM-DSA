...
public class ObjectHelperTest {
    ...
    public void testObjectGetFields() {
        ...
        Assert.assertEquals(8, strings.length);
    }
    ...
    public void testAssertEqual() throws NoSuchFieldException, InvocationTargetException, IllegalAccessException {
        User user1 = new User("1", "Lluc", "Feixa", "29/12/2001", 50, 1, "llucfeixa@gmail.com", "123");
        User user2 = new User("1", "Lluc", "Feixa", "29/12/2001", 50, 1,"llucfeixa@gmail.com", "123");
